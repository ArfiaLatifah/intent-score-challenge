...
public class MainActivity extends AppCompatActivity {
    ...
    public void handleNext(View view) {
        ...
        if ((homeTeam).equals("")) {
            Toast.makeText(this, "Anda belum memasukkan nama home team", Toast.LENGTH_SHORT).show();
            homeStatus = false;
        } else {
            homeStatus = true;
        }
        ...
        if ((awayTeam).equals("")) {
            Toast.makeText(this, "Anda belum memasukkan nama away team", Toast.LENGTH_SHORT).show();
            awayStatus = false;
        } else {
            awayStatus = true;
        }
        ...
        if (homeBitmap == null) {
            Toast.makeText(this, "Anda belum memasukkan logo home team", Toast.LENGTH_SHORT).show();
        ...
        if (awayBitmap == null) {
            Toast.makeText(this, "Anda belum memasukkan logo away team", Toast.LENGTH_SHORT).show();
